    ...
    <>
      ...
      {loaded && tasks ? (
        <div className="max-h-56 pl-10">
          <div className=" relative overflow-x-auto shadow-md sm:rounded-lg max-h-48"> 
            <table className=" table-fixed w-full text-sm text-left text-gray-500 dark:text-gray-400">
              ...
              <tbody className=" justify-between overflow-y-scroll " >
                  ...
                  { tasks.map( ( task ) => (
                      ...
                      <tr className="bg-white border-b dark:bg-gray-600 dark:border-gray-500 hover:bg-gray-50 dark:hover:bg-gray-600 text-white"
                          ...
                          <td className="px-6 py-4 text-right">
                            <button type="button"
                                    className="py-1 px-3 inline-flex justify-center items-center gap-2 -ml-px first:rounded-l-lg first:ml-0 last:rounded-r-lg border font-medium bg-white text-gray-700 align-middle hover:bg-gray-50 focus:z-10 focus:outline-none focus:ring-2 focus:ring-blue-600 transition-all text-sm dark:bg-gray-700 dark:hover:bg-slate-800 dark:border-gray-600 dark:text-gray-400"
